...
<%
	String this_url = "index.jsp";
	session.setAttribute("url", this_url);
...
<body>
	...
	<div id="wrapperDiv">
        <div class="updownDiv">
	        ...
	        <div class="inupdownDiv">
	          	<a href="index.jsp" target="self">HOME</a>
	        </div><%
	        
		        if(session_Check){
		    %><div class="inupdownDiv">
		    	<a href="login.jsp<%=this_url%>">
		    		<div>
		    			로그인
		    		</div>
		    	</a>
	        ...
	        %><div class="inupdownDiv">
	        	<a href="board1.jsp<%=this_url%>">게시판1</a>
	        </div><%
	        
	        %><div class="inupdownDiv">
	        	<a href="board2.jsp<%=this_url%>">게시판2</a>
	        </div><%
	        
	        %><div class="inupdownDiv">
	        	<a href="registerForm.jsp<%=this_url%>">회원가입</a>
	        </div>
